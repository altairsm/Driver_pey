  ...
  useEffect(() => {
    const check = async () => {
      try {
        ...
        if (user.leu_regras) setConfirmado(true);
  ...
  return (
    <div style={s.container}>
      ...
      <div style={s.content}>
        ...
        <div style={s.sub}>
          Regras para solicitar o adiantamento de pagamento de um romaneio.<br />
          ...
          Com o adiantamento, você pode receber antes se o romaneio atender todos os critérios abaixo.
        </div>
        ...
        <div style={s.card}>
          ...
          <div style={s.cardBody}>
            ...
            <span style={s.highlight('#f0c040')}>
              (CTRCs com ocorrência "entregue" ÷ Total de CTRCs no período) × 100
            </span>
          </div>
        </div>
        ...
        <div style={s.card}>
          <div style={s.cardHeader('#5ab4ff')}>
            ...
            <div style={s.cardTitle}>Romaneio com CTRCs entregues</div>
          </div>
          <div style={s.cardBody}>
            O romaneio deve ter pelo menos um CTRC com ocorrência de entrega confirmada no período da quinzena.
            <br /><br />
            Romaneios sem CTRCs entregues não são elegíveis para adiantamento.
          </div>
        </div>
        ...
        <div style={s.card}>
          <div style={s.cardHeader('#f0c040')}>
            ...
            <div style={s.cardTitle}>Valor por cidade (tabela de preços)</div>
          </div>
          <div style={s.cardBody}>
            O pagamento de cada CTRC é calculado com base no valor definido por cidade de entrega na
            <strong style={{ color: '#e8eaf0' }}> tabela de preços por cidade</strong>.
            <br /><br />
            O valor do romaneio é a soma dos valores de todos os CTRCs entregues na quinzena.
            <br /><br />
            O adiantamento tem limite máximo de <strong style={{ color: '#e8eaf0' }}>R$ {Number(config?.valor_maximo_adiantamento || 400).toFixed(2)}</strong>.
          </div>
        </div>
        ...
        <div style={s.card}>
          ...
          <div style={s.cardBody}>
            Sobre o valor adiantado é aplicada uma <strong style={{ color: '#e8eaf0' }}>taxa</strong> (percentual configurado pela administração).
            O valor líquido recebido é:
            <br /><br />
            <span style={s.highlight('#f0c040')}>
              Valor do romaneio × (1 − taxa%)
            </span>
            <br /><br />
        ...
        <div style={s.card}>
          ...
          <div style={s.cardBody}>
            Cada romaneio só pode ter uma solicitação ativa por vez. Se já houver uma solicitação
            <strong style={{ color: '#ff9f40' }}> pendente</strong> ou
            <strong style={{ color: '#3de8a0' }}> aprovada</strong> para o mesmo romaneio,
        ...
        <div style={s.card}>
          ...
          <div style={s.cardBody}>
            No painel principal, cada card de romaneio mostra um botão{' '}
            ...
            <br />
            <strong style={{ color: '#6b7280' }}>Botão cinza</strong> → O romaneio não atende um ou mais critérios.
            <br /><br />
            Após solicitar, a solicitação fica <strong style={{ color: '#ff9f40' }}>pendente</strong> para análise. O administrador poderá aprovar ou recusar.
          </div>
        </div>
        ...
        {confirmado ? (
          ...
          <div style={{ textAlign: 'center', marginTop: 24 }}>
            <button onClick={handleConfirmar} disabled={confirmando}
              style={{ ...s.confirmBtn, ...(confirmando ? s.confirmBtnDisabled : {}) }}>
