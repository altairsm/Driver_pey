  ...
  const entregasData = useMemo(() => {
    ...
    return resumo.motoristas
      ...
      .map((m) => ({
        ...
        total: Number(m.qtd_reclamacoes_total || 0) || Number(m.qtd_reclamacoes || 0),
        resolvidas: Number(m.qtd_reclamacoes_resolvidas || 0),
        pendentes: Math.max(0, (Number(m.qtd_reclamacoes_total || 0) || Number(m.qtd_reclamacoes || 0)) - Number(m.qtd_reclamacoes_resolvidas || 0)),
